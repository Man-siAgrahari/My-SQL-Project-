...
drop database online_retailshop_database;
create table Users ( user_id int (10) not null primary key, name varchar (20), phone_number varchar (20) not null); 
describe Users;


INSERT INTO Users (user_id,name, phone_number) VALUES (1,'Leonard Carroll','809-902-4957'),
 (2,'Sybill C. Kane','797-156-7733'),
 (3,'Ryder Stanton','857-833-6279'),  (4,'Owen Robbins','102-490-9669'),
...
, (12,'Inga K. Gonzales','736-865-1874'), (13,'Orson Dale','997-968-1425'), (14,'Rahim Mcdowell','554-339-3873'),
...
(20,'Blair N. Weeks','563-321-0004'), (21,'Walter Callahan','568-397-1819'),
(22,'Brynne V. Hayes','181-495-6507'),
(23,'Hedy U. Wise','499-991-2743'),
 (24,'Nevada Langley','619-882-8501'), (25,'Sasha Church','853-381-3371'),
 (26,'Tamekah Cantu','332-466-8999'),(27,'Regan R. Cook','280-150-3915'),
 (28,'Christian England','385-898-0420'),
(29,'Kevyn P. Cox','768-396-9425'), (30,'Leah B. Franklin','853-688-0957'),
(31,'Urielle Humphrey','926-331-0012'),
(32,'Kendall Lane','661-911-8866'),
(33,'Ezra Randolph','922-755-8559'), (34,'Ashton Maddox','523-845-2705'),
(35,'Sopoline Spence','614-499-4578'),
(36,'Justin Guerrero','516-139-5882'), (37,'Phoebe S. Wynn','264-976-8713'),
(38,'Noble R. Flynn','501-240-1875'),
(39,'Buffy S. Chandler','859-284-1514'),(40,'Finn Hood','183-267-5415'),
...
(53,'Mona M. Hurley','238-367-9905'), (54,'Isadora Y. Durham','284-851-0165'),
...
(56,'Blaze B. Aguirre','916-218-1512'),
 ...
 (74,'Aline Hampton','193-284-2494'), (75,'Lucy Q. Andrews','593-876-6529'),
 (76,'Athena P. Gray','393-826-7570'),
 (77,'Violet S. Underwood','425-483-4304'),
(78,'Lev Phillips','281-817-4060'),(79,'Deanna Z. Snider','444-315-3902'),
 (80,'Otto U. Frye','384-258-6411'),
(81,'Tatiana Dickson','180-578-2636'),
 (82,'Cathleen R. Aguilar','577-690-7062'),
(83,'Sylvester H. Wiley','914-931-6799'), (84,'Xander G. Thornton','871-337-1836'),
(85,'Rooney Hunter','857-195-6423'),
 (86,'Theodore G. Macias','412-369-2301'), (87,'Britanney Boyer','493-286-6876'),
(88,'Wang Harper','923-883-5069'),
 (89,'Benjamin V. Young','652-797-0120'),
 (90,'Gray Z. Conner','202-685-6363'),
(91,'Amal Mccoy','419-663-7344'),
 (92,'Kyra G. Reed','990-385-6303'), (93,'Reuben Gilmore','749-575-5329'),(94,'Thomas G. Robles','231-847-0873'),
 (95,'Kylynn L. Hardin','606-903-9466'), (96,'Regina F. Larsen','338-386-8025'),
 (97,'Xantha U. Graham','146-582-9214'),
 (98,'Adara N. Leonard','902-263-9357'),
 (99,'Ashton V. Hubbard','320-269-9789'), (100,'Robert Lester','579-713-6386');
...
update buyer set user_id = 40 where user_id =41;
...
delete from Seller where user_id =30;
insert into Seller values (33), (23), (22), (90), (12);
...
alter table address add column contact int (10);

alter table address rename column contact to job_code;

alter table address drop column job_code;
...
update store set startTime = ( '2007-7-12') where sid = 10; 
select * from Store;
...
update  After_Sales_Service_At set brandName = 'HP' where spid = 34;
